  ...
  useEffect(() => {
    async function loadMarkets() {
      try {
        ...
        // For now, use static data for the two demo markets (hardcoded addresses)
        const marketData: Market[] = [
          {
            ...
            yesPrice: 0.52,
            noPrice: 0.48,
            totalLiquidity: 1250, // Demo liquidity
          },
          {
            address: '0xb7917a5843afa8ac272250f722cbf36213dde3ac',
            ...
            yesPrice: 0.68,
            noPrice: 0.32,
            totalLiquidity: 820, // Demo liquidity
          }
        ]
